...
import { GroupedComboboxContainerProps, FilterTypeEnum } from "../../../typings/GroupedComboboxProps";

type ExtractionReturnValue = [EditableValue<string>, DynamicValue<string> | undefined, boolean, FilterTypeEnum];

export function extractEnumerationProps(props: GroupedComboboxContainerProps): ExtractionReturnValue {
