...
import { GroupedComboboxPreviewProps, FilterTypeEnum, SelectedItemsSortingEnum } from "typings/GroupedComboboxProps";
...
export function getDatasourcePlaceholderText(args: GroupedComboboxPreviewProps): string {
    const {
        optionsSourceType,
