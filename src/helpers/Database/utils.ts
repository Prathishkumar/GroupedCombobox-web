...
export function extractDatabaseProps(props: GroupedComboboxContainerProps): ExtractionReturnValue {
...
export function getReadonly(
    ...
    customEditability: GroupedComboboxContainerProps["customEditability"],
    customEditabilityExpression: GroupedComboboxContainerProps["customEditabilityExpression"]
): boolean {
    if (targetAttribute) {
