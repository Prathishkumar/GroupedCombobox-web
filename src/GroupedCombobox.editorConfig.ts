...
import { GroupedComboboxPreviewProps } from "../typings/GroupedComboboxProps";
...
const LAZY_LOADING_CONFIG: Array<keyof GroupedComboboxPreviewProps> = ["lazyLoading", "loadingType"];
const DATABASE_SOURCE_CONFIG: Array<keyof GroupedComboboxPreviewProps> = [
...
const ASSOCIATION_SOURCE_CONFIG: Array<keyof GroupedComboboxPreviewProps> = [
...
export function getProperties(
    values: GroupedComboboxPreviewProps & { Editability?: unknown },
...
export function getPreview(_values: GroupedComboboxPreviewProps, isDarkMode: boolean): StructurePreviewProps {
...
export function getCustomCaption(values: GroupedComboboxPreviewProps): string {
