...
import { GroupedComboboxContainerProps, OptionsSourceAssociationCaptionTypeEnum } from "../../typings/GroupedComboboxProps";
...
describe("Combo box (Association)", () => {
    ...
    let defaultProps: GroupedComboboxContainerProps;
    beforeEach(() => {
        defaultProps = {
            name: "comboBox",
            id: "comboBox1",
