/**
 * This file was generated from GroupedCombobox.xml
...
export interface GroupedComboboxContainerProps {
    name: string;
    tabIndex?: number;
    id: string;
    source: SourceEnum;
    ...
    optionsSourceAssociationGroupAttribute?: ListAttributeValue<string>;
    optionsSourceDatabaseGroupAttribute?: ListAttributeValue<string>;
...
export interface GroupedComboboxPreviewProps {
    readOnly: boolean;
    ...
    optionsSourceAssociationGroupAttribute: string;
    optionsSourceDatabaseGroupAttribute: string;
